...
const Navbar = () => {
  ...
  return (
    <nav className='fixed top-0 left-0 w-full flex h-[110px] pl-4 pr-4 sm:pl-10 sm:pr-10 lg:pl-16 lg:pr-16 justify-between font-dm-sans items-center shadow-sm bg-white z-50'>
      ...
      <div className={`${isOpen ? ' transition-transform -translate-x-full' : ' transition-transform translate-x-5'} lg:transition-none lg:transform-none lg:items-center lg:flex gap-6 lg:static absolute top-full left-full leading-8 h-screen lg:h-auto bg-white z-40`}>
